...
export default function Hero() {
  ...
  return (
    <section
      id="inicio"
      className="relative flex w-full items-center justify-center min-h-[100dvh] bg-[url('/images/hero/hero-mobile.webp')] md:bg-[url('/images/hero/hero.webp')] bg-cover bg-center bg-no-repeat"
    >
      {/* Overlay leve */}
